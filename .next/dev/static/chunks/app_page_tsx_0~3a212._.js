...
function Home() {
    ...
    const [filledPdfUrl, setFilledPdfUrl] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    const answeredCount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "Home.useMemo[answeredCount]": ()=>Object.values(values).filter({
                "Home.useMemo[answeredCount]": (value)=>value.trim()
            }["Home.useMemo[answeredCount]"]).length
    }["Home.useMemo[answeredCount]"], [
        values
    ]);
    ...
    async function createFilledPdf() {
        ...
        const pdfDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$PDFDocument$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__PDFDocument$3e$__["PDFDocument"].load(existingPdfBytes);
        ...
        for (const field of fields){
            ...
            lines.slice(0, maxLines).forEach((line, index)=>{
                page.drawText(line, {
                    ...
                    size: fontSize,
                    font,
                    color: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$pdf$2d$lib$2f$es$2f$api$2f$colors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["rgb"])(0.1, 0.1, 0.1),
                    maxWidth: field.w
                });
            });
        }
...
_s(Home, "mSe9vvLWNlfTr7t3K4K+/7ReAtY=");
_c = Home;
const styles = {
    page: {
        minHeight: "100vh",
